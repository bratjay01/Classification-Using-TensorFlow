...
class MyCustomModel(tensorflow.keras.Model):    #the mother class
...
def streetsigns_model(nbr_classes):
    ...
    my_input = Input(shape=(60,60,3))  #RGB images so 3 channel
    ...
    x = Flatten()(x)   #flattens all values from previous layer
    #x = GlobalAvgPool2D()(x)  
